...
export default class CSLoginPacket {
    ...
    deserialize(packet) {
        ...
        const brand = MineProtocol.readString(fard.newBuffer), version = MineProtocol.readString(brand.newBuffer), username = MineProtocol.readString(version.newBuffer, 1);
